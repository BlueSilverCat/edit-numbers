...
export function paddingNumber(num, base, place, upperCase, paddingChar, align) {
...
export function enclose(string, open, close) {
  return open + string + close;
}

export function countCapturingGroup(string) {
  let count = 0;
...
export function backCountSequentialChar(string, index, char) {
  let count = 0;
